...
export default async function Layout1Page() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f0e5]">
      {/* Navigation */}
      <div className="max-w-6xl mx-auto mb-6 flex justify-between items-center p-4">
        <Link href="/" className="text-blue-800 underline">
          Back to Home
        </Link>
        <h1 className="text-2xl font-bold">Layout1 Branch Design</h1>
        ...
        <div className="relative border-8 border-gray-300 bg-[#f5f0e5] mx-4 mt-12">
          ...
          <div className="w-full relative p-6 h-[500px]">
            ...
            <div className="absolute bottom-12 right-8 w-1/3 text-right">
              <h2 className="text-2xl font-bold mb-2 text-black bg-white/80 p-2 inline-block">
                News
              </h2>
              <p className="text-sm leading-relaxed text-black bg-white/80 p-2">
                {latestPost
                  ? latestPost.excerpt
                  : "Sample sample samplesample sample samplesample sample samplesample"}
              </p>
            </div>
            ...
            <div className="absolute bottom-0 left-8 transform translate-y-1/4">
              <div className="relative">
                ...
                />
                <span className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white font-bold">
                  donation
                </span>
              </div>
            </div>
