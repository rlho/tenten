  ...
  return (
    <html lang="en" className={inter.variable}>
      <body className="bg-[#e6ddc6]">
        {/* 全てのページで固定表示されるロゴ */}
        <div className="fixed top-1 left-0 right-0 flex justify-center items-center my-2 z-50 w-full">
          <img
            src="/logo.png"
            alt="TEN TEN"
        ...
        <section className="max-w-6xl mx-auto min-h-screen">
          {/* 共通ヘッダー部分 */}
          <header className="text-center border-b-2 border-[#222] pt-20 sm:pt-28 md:pt-36">
