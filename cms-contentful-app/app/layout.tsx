    ...
    <footer className="bg-white">
      <div className="flex">
        ...
        <div className="w-1/6">
          <div className="flex flex-col space-y-4 items-center py-4">
            ...
            <div className="w-32 h-32 bg-yellow-300 flex flex-col items-center justify-center mt-3">
      ...
      <div className="bg-white p-4 border-t border-gray-200">
        <div className="flex justify-center items-center space-x-6">
          <img src="/sponsors/clip-path-group-16.png" alt="Sponsor 1" className="h-10 w-auto" />
          <img src="/sponsors/clip-path-group-17.png" alt="Sponsor 2" className="h-10 w-auto" />
          <img src="/sponsors/clip-path-group-18.png" alt="Sponsor 3" className="h-10 w-auto" />
          <img src="/sponsors/clip-path-group-19.png" alt="Sponsor 4" className="h-10 w-auto" />
          <img src="/sponsors/clip-path-group-20.png" alt="Sponsor 5" className="h-10 w-auto" />
          <img src="/sponsors/dokidoki.png" alt="Sponsor 6" className="h-10 w-auto" />
          <img src="/sponsors/sponsors1.png" alt="Sponsor 7" className="h-10 w-auto" />
        </div>
      </div>
    </footer>
  );
